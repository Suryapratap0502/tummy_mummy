...
<head>
  <meta charset="utf-8" />
  <title>Dashboard | Tummy Mummy - Admin </title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta content="Tummy Mummy Admin" name="description" />
  <meta content="Maisha Infotech Pvt Ltd" name="author" />
  <meta content="Developer - Surya Pratap" name="author" />
  ...
  <script src="{{ asset('assets/libs/sweetalert2/sweetalert2.min.js')}}"></script>
    ...
    <script src="{{ asset('assets/js/admin/delivery_vendor.js')}}"></script>
    <script src="{{ asset('assets/js/admin/warehouse.js')}}"></script>
              ...
              <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                  <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                      <a href="#!" class="btn btn-sm btn-soft-info shadow-none">
                        View All Apps
              ...
              <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="d-flex align-items-center">
                  ...
                  <span class="text-start ms-xl-2">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ getuserdetail('name')}}</span>
                    <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{ getRoleName(getuserdetail('role'))}}</span>
                  </span>
                </span>
              </button>
              <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <h6 class="dropdown-header">Welcome {{ getuserdetail('name')}}</h6>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mt-2 text-center">
              <lord-icon src="{{ asset('assets\js\gsqxdxog.json')}}" trigger="loop" colors="primary:#f7b84b,secondary:#f06548" style="width: 100px; height: 100px"></lord-icon>
    ...
    <div class="app-menu navbar-menu">
      ...
      <div class="navbar-brand-box">
        ...
        <a href="{{url('/')}}" class="logo logo-dark">
          <span class="logo-sm">
            <img src="{{ asset('assets/images/logo_tm.png')}}" alt="" />
          </span>
          <span class="logo-lg">
            <img src="{{ asset('assets/images/logo_tm.png')}}" alt="" />
          </span>
      ...
      <div id="scrollbar">
        <div class="container-fluid">
          ...
          <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="menu-title"><span data-key="t-menu">Admin Menus</span></li>
            <li class="nav-item">
            ...
            <li class="menu-title">
              ...
              <span data-key="t-pages">{{$values['menu']}}</span>
            </li>
            <li class="nav-item">
              @if(!empty($values['innermenu']))
              <a class="nav-link menu-link" href="#user_{{$values['id']}}" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                <i class="mdi {{$values['icon']}}"></i>
                <span data-key="t-{{$values['slug']}}">{{$values['menu']}}</span>
              </a>
              @else
              <li class="nav-item">
                <a class="nav-link menu-link" href="{{ url($values['slug']) }}">
                  <i class="mdi {{$values['icon']}}"></i> <span data-key="t-{{$values['slug']}}">{{$values['menu']}}</span>
                </a>
                </li>
                @endif
              <div class="collapse menu-dropdown" id="user_{{$values['id']}}">
                @if(!empty($values['innermenu']))
                <ul class="nav nav-sm flex-column">
                  @foreach($values['innermenu'] as $innerval)
                  <li class="nav-item menu-link">
                    <a href="{{ url($innerval['slug']) }}" class="nav-link" data-key="t-{{ $innerval['slug']  }}">
                      {{ $innerval['inner_menu']}}
                    </a>
                  </li>
                  @endforeach
