              ...
              <div class="col-12">
                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                  <div class="flex-grow-1">
                    <h4 class="fs-16 mb-1">Good Morning, Kshitij!</h4>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div>
                                  <h5 class="fs-14 my-1">
                                    <a href="javascript:void(0)" class="text-reset">Branded T-Shirts</a>
                                  </h5>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div>
                                  <h5 class="fs-14 my-1">
                                    <a href="javascript:void(0)" class="text-reset">Borosil Paper Cup</a>
                                  </h5>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div>
                                  <h5 class="fs-14 my-1">
                                    <a href="javascript:void(0)" class="text-reset">One Seater Sofa</a>
                                  </h5>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                <div>
                                  <h5 class="fs-14 my-1 fw-medium">
                                    <a href="javascript:void(0)" class="text-reset">iTest Factory</a>
                                  </h5>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                  <h5 class="fs-14 my-1 fw-medium">
                                    <a href="javascript:void(0)" class="text-reset">Digitech Galaxy</a>
                                  </h5>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="flex-gow-1">
                                  <h5 class="fs-14 my-1 fw-medium">
                                    <a href="javascript:void(0)" class="text-reset">Nesta Technologies</a>
                                  </h5>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                  <h5 class="fs-14 my-1 fw-medium">
                                    <a href="javascript:void(0)" class="text-reset">Zoetic Fashion</a>
                                  </h5>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                  <h5 class="fs-14 my-1 fw-medium">
                                    <a href="javascript:void(0)" class="text-reset">Meta4Systems</a>
                                  </h5>
                    ...
                    <div class="table-responsive table-card">
                      <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <a href="javascript:void(0)" class="fw-medium link-primary">#VZ2112</a>
                            </td>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2">
                          ...
                          <tr>
                            <td>
                              <a href="javascript:void(0)" class="fw-medium link-primary">#VZ2111</a>
                            </td>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2">
                          ...
                          <tr>
                            <td>
                              <a href="javascript:void(0)" class="fw-medium link-primary">#VZ2109</a>
                            </td>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2">
                          ...
                          <tr>
                            <td>
                              <a href="javascript:void(0)" class="fw-medium link-primary">#VZ2108</a>
                            </td>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2">
                          ...
                          <tr>
                            <td>
                              <a href="javascript:void(0)" class="fw-medium link-primary">#VZ2107</a>
                            </td>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2">
                  ...
                  <div class="acitivity-timeline acitivity-main">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                          <a href="javascript:void(0)" class="bg-light rounded p-1">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1 lh-base">
                          Today offers by
                          <a href="javascript:void(0)" class="link-secondary">Digitech Galaxy</a>
                        </h6>
