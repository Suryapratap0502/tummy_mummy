...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!--end row-->
            <!-- Modal -->
            <div class="modal fade zoomIn" id="add_role_model" tabindex="-1" aria-labelledby="addSellerLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header bg-info-subtle p-3">
                            <h5 class="modal-title" id="addSellerLabel">Add Role</h5>
                            ...
                            <form id="add_role" method="post">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="role_name[]"
                                                    id="role_name" placeholder="Enter Role" />
                                ...
                                <div class="col-lg-12 mt-3">
                                    <div class="hstack gap-2 justify-content-end">
                                        <button type="button" class="btn btn-soft-danger text-decoration-none fw-medium" data-bs-dismiss="modal" aria-label="Close">
                                            Close</button>
    ...
    <script>
        ...
        function add_row() {
            ...
            html +=
                '<div class="col-lg-9"><div class="mb-3"><label for="role_name" class="form-label">Name</label><input type="text" class="form-control" name="role_name[]" id="name" placeholder="Enter Role" /></div></div>';

            html += '<div class="col-lg-3"> <button type="button" onclick="removerow(' + rowcount +
