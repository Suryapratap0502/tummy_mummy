...
class WarehouseController extends Controller
{
    ...
    public function add_form()
    {
        ...
        $data['role'] = RoleModel::where('flag','1')->where('name','Warehouse Vendor')->first();
        return view('warehouse/add_form',$data);
    }

    public function list()
    {
        return view('warehouse/list_ajax');
    }
    ...
    public function add(Request $request)
    {
        $validate = Validator::make($request->all(), [
            ...
            'is_del_access' => 'required',
            'warehouse_type' => 'required',
            'warehouse_name' => 'required',
            'warehouse_contact_no' => 'required',
            'facilities' => 'required',
            'warehouse_lat' => 'required',
            'warehouse_long' => 'required',
            'state' => 'required',
            'city' => 'required',
            'pin' => 'required',
            'address' => 'required',
        ...
        if ($validate->fails()) {
            ...
            $data_admin['designation'] = 'Warehouse';
