...
INSERT INTO `admin` (`id`, `name`, `email`, `password`, `role`, `designation`, `contact`, `image`, `flag`, `created_at`, `updated_at`) VALUES
(1, 'Master Admin', 'admin@tummymummy.com', '$2y$10$pSEdSnmlRZiVEJDoqh0SXemUj2yDABjng4Z2ABVcOohMOq.pUMfOq', 1, '', 0, '', 1, '2023-07-25 06:42:13', '2023-07-29 11:54:27'),
(2, 'Surya Pratap', 'surya@gmail.com', '$2y$10$4WWXz4LuRgjBA/oXsEMuWu.EC2deFJtLwJieDReAAnnmq8r1EcAD2', 22, 'Sr. PHP Developer', 8418858198, '202307291633surya-sir.png', 1, '2023-07-29 11:03:14', '2023-07-29 06:45:43'),
(3, 'Maisha ', 'admin@maisha.com', '$2y$10$LyWg788wqkJ5UHFvlnTbe.uj6d9wrdWJ/WBs8YGYz/Em9qTiQCTEO', 22, 'Super Admin', 9999999999, NULL, 1, '2023-07-29 11:18:00', '2023-07-29 11:54:27');
...
INSERT INTO `area_type` (`id`, `name`, `flag`) VALUES
(1, 'Urban', 1),
(2, 'Rural', 1),
(3, 'Semi Urban', 1);
...
CREATE TABLE `bank_details` (
  ...
  `bank_holder_name` varchar(55) NOT NULL,
...
(1, 'Staff Management', 'staff_management', 'mdi-account-circle', 1, '2022-12-26 13:31:56', NULL),
(2, 'Vendor Management', 'vendor_management', 'mdi-account-tie-hat-outline', 0, NULL, NULL),
(3, 'Warehouses', 'warehouse_management', 'mdi-warehouse', 0, NULL, NULL),
...
(2, 1, 'Staff', 'staff', 1, NULL, NULL),
(3, 2, 'Vendor Category', 'vendor_category', 1, NULL, NULL),
(4, 2, 'Vendors', 'vendors', 0, NULL, NULL);
...
INSERT INTO `role` (`id`, `name`, `flag`, `created_at`, `updated_at`) VALUES
(1, 'Master Admin', 1, '2023-07-24 12:47:04', '2023-07-29 05:56:15'),
(22, 'Staff', 1, '2023-07-29 05:45:48', '2023-07-29 06:54:24'),
(23, 'Vendor', 1, '2023-07-29 09:43:15', '2023-07-29 09:43:15');
...
CREATE TABLE `vendor` (
  ...
  `vendor_type` varchar(55) NOT NULL,
  `area_type` int(11) NOT NULL,
  `name` varchar(55) NOT NULL,
  `email` varchar(55) NOT NULL,
  `password` varchar(100) NOT NULL,
  `gender` varchar(55) NOT NULL,
  `mobile_communication` bigint(20) NOT NULL,
  `mobile_upi` bigint(20) DEFAULT NULL,
  `image` text DEFAULT NULL,
  ...
  `pin` int(10) NOT NULL,
  `gst_in` varchar(55) NOT NULL,
  `fssai_registration_status` varchar(20) NOT NULL,
  `fssai_registration_docs` text DEFAULT NULL,
  `fssai_registration_number` bigint(20) DEFAULT NULL,
  `warehouse_member` varchar(55) NOT NULL,
...
CREATE TABLE `vendor_business_details` (
  ...
  `other_business` varchar(55) DEFAULT NULL,
  `business_name` varchar(55) NOT NULL,
  `est_year` varchar(55) NOT NULL,
  `registration_year` varchar(55) NOT NULL,
  `registration_no` varchar(55) NOT NULL,
  `office_address` text NOT NULL,
  `business_email` varchar(55) NOT NULL,
  `business_pan` varchar(55) NOT NULL,
  `udyog_aadhar` bigint(20) NOT NULL,
  `website` text NOT NULL,
  `is_exp_imp` varchar(55) NOT NULL,
  `flag` int(11) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `vendor_category` (
  ...
  `name` varchar(55) NOT NULL,
  `image` text DEFAULT NULL,
  `is_fssai_req` varchar(11) DEFAULT 'No',
  `flag` int(11) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `vendor_category` (`id`, `name`, `image`, `is_fssai_req`, `flag`, `created_at`, `updated_at`) VALUES
(1, 'test', '202307311842variable.png', 'No', 1, '2023-07-31 13:12:28', '2023-07-31 13:12:28');

-- --------------------------------------------------------

--
-- Table structure for table `vendor_in_category`
--

CREATE TABLE `vendor_in_category` (
  `id` int(11) NOT NULL,
  `vendor_id` int(11) NOT NULL,
...
--
-- Indexes for table `vendor_in_category`
--
ALTER TABLE `vendor_in_category`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `vendor_in_category`
--
ALTER TABLE `vendor_in_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
